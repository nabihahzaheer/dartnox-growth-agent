...
function compactTrace(
  ...
  return [
    { ...base, id: idFor(1), seq: 1, type: 'thinking' as const, label: 'Load slot context',
    ...
    { ...base, id: idFor(2), seq: 2, type: 'tool_call' as const, label: 'fetch_source',
      started_at: t(4), latency_ms: 1700, tool_name: 'fetch_source' as const },
    { ...base, id: idFor(3), seq: 3, type: 'tool_result' as const, label: 'fetch_source → 1 document',
      started_at: t(7), latency_ms: 2100, tool_name: 'fetch_source' as const, outcome: 'ok' as const },
    { ...base, id: idFor(4), seq: 4, type: 'thinking' as const, label: 'Summarise sources',
    ...
    { ...base, id: idFor(5), seq: 5, type: 'action' as const, label: 'Write the draft',
    ...
    { ...base, id: idFor(6), seq: 6, type: 'action' as const, label: 'Score the draft',
